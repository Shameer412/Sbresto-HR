...
import { ROLE_NAV_ITEMS, ROLES } from '../../config/navigation';
...
const DashboardLayout = () => {
  ...
  const roleKey = user.role && typeof user.role === 'object' ? user.role.name : user.role;
  ...
  const activeTab = menuItems.find(item => item.id === currentPath)?.id || menuItems[0]?.id;
